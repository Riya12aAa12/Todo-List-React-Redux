          ...
          output = (
            <div>
                <label>
                  ...
                  <span className="list-id-check"><input 
                      type='checkbox'
                      onClick={() => completeTodo(todo.id)}
                    /></span> | 
                  <span className='list-id-edit' onClick={() => this.handleDoubleClick()}><FontAwesome name='pencil' /> Edit </span>
                </label>
                
                <button className="delete"
                        onClick={() => deleteTodo(todo.id)}><FontAwesome name='trash-o' /> Delete</button>
            </div>
          )
      }
    return (
